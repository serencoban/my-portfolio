...
require __DIR__ . '/my-portfolio-blog-header.php';
...
if ( ! is_main_site() ) {
	wp_redirect( network_site_url( 'my-portfolio-signup.php' ) );
	die();
}
...
function signup_another_blog( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	<form id="setupform" method="post" action="my-portfolio-signup.php">
...
function confirm_another_blog_signup( $domain, $path, $blog_title, $user_name, $user_email = '', $meta = array(), $blog_id = 0 ) {
	...
	if ( $blog_id ) {
		...
		$login_url = 'http://' . $domain . $path . 'my-portfolio-login.php';
	}
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	...
	<form id="setupform" method="post" action="my-portfolio-signup.php" novalidate="novalidate">
		<input type="hidden" name="stage" value="validate-user-signup" />
		<?php
		/** This action is documented in my-portfolio-signup.php */
...
function validate_user_signup() {
	...
	/** This filter is documented in my-portfolio-signup.php */
...
if ( 'none' === $active_signup ) {
	...
	$login_url = wp_login_url( network_site_url( 'my-portfolio-signup.php' ) );
