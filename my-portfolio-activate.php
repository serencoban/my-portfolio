...
<div id="signup-content" class="widecolumn">
	...
	<?php if ( ! $key ) { ?>
		...
		<form name="activateform" id="activateform" method="post" action="<?php echo esc_url( network_site_url( $blog_details->path . 'my-portfolio-activate.php' ) ); ?>">
			<p>
		...
		if ( is_wp_error( $result ) && in_array( $result->get_error_code(), $valid_error_codes, true ) ) {
			...
			if ( '' === $signup->domain . $signup->path ) {
				printf(
					...
					esc_url( network_site_url( $blog_details->path . 'my-portfolio-login.php', 'login' ) ),
