...
<section class="intro">
    <p>Welcome to my garden where aesthetics and functionality grow together...</p>
    <a href="#" class="btn">About me</a>
</section>

<section class="flower-section">
    <img src="<?php echo get_template_directory_uri(); ?>/wp-content/themes/portfolio/resources/img/flower.png" alt="Fleur" class="flower">
