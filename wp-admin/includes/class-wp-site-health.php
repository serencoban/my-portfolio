...
class WP_Site_Health {
			...
			if ( wp_is_https_supported() ) {
				...
				if ( defined( 'WP_HOME' ) || defined( 'WP_SITEURL' ) ) {
					$result['description'] .= sprintf(
						'<p>%s</p>',
						sprintf(
							/* translators: 1: my-portfolio-config.php, 2: WP_HOME, 3: WP_SITEURL */
	...
	public function can_perform_loopback() {
		...
		$url = site_url( 'my-portfolio-cron.php' );

		/*
		 * A post request is used for the my-portfolio-cron.php loopback test to cause the file
		 ...
		 * GET request WordPress uses for my-portfolio-cron.php loopback requests but is close
	...
	private function check_for_page_caching() {
		...
		return array(
			'advanced_cache_present'        => (
				...
				&&
				/** This filter is documented in my-portfolio-settings.php */
