 ...
 * that it is properly set, such as in my-portfolio-config.php, for your environment.
 *
...
/**
 * Handles the submission of a comment, usually posted to my-portfolio-comments-post.php via a comment form.
 *
