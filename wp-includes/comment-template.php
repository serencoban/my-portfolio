...
function get_trackback_url() {
	if ( get_option( 'permalink_structure' ) ) {
		...
		$trackback_url = get_option( 'siteurl' ) . '/my-portfolio-trackback.php?p=' . get_the_ID();
	}
 ...
 *     @type string $action               The comment form element action attribute. Default '/my-portfolio-comments-post.php'.
...
function comment_form( $args = array(), $post = null ) {
	...
	$defaults = array(
		...
		'comment_notes_after'  => '',
		'action'               => site_url( '/my-portfolio-comments-post.php' ),
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
