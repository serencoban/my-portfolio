...
function get_the_password_form( $post = 0 ) {
	...
	$output = '<form action="' . esc_url( site_url( 'my-portfolio-login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form' . $class . '" method="post">' . $redirect_field . $invalid_password_html . '
