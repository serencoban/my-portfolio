	...
	if ( is_404() ) {
		...
		if ( 'wp-register.php' === basename( $redirect['path'] ) ) {
			if ( is_multisite() ) {
				...
				$redirect_url = apply_filters( 'wp_signup_location', network_site_url( 'my-portfolio-signup.php' ) );
			} else {
 ...
 * Visiting /login redirects to /my-portfolio-login.php, and so on.
 *
 * @since 3.4.0
 *
 * @global WP_Rewrite $wp_rewrite WordPress rewrite component.
...
function wp_redirect_admin_locations() {
	...
	$logins = array(
		home_url( 'my-portfolio-login.php', 'relative' ),
