...
function spawn_cron( $gmt_time = 0 ) {
	...
	if ( defined( 'ALTERNATE_WP_CRON' ) && ALTERNATE_WP_CRON ) {
		...
		require_once ABSPATH . 'my-portfolio-cron.php';
		return true;
	}
	...
	$cron_request = apply_filters(
		'cron_request',
		array(
			'url'  => add_query_arg( 'doing_wp_cron', $doing_wp_cron, site_url( 'my-portfolio-cron.php' ) ),
			'key'  => $doing_wp_cron,
			'args' => array(
				'timeout'   => 0.01,
				'blocking'  => false,
 ...
 */
function _wp_cron() {
	// Prevent infinite loops caused by lack of my-portfolio-cron.php.
	if ( str_contains( $_SERVER['REQUEST_URI'], '/my-portfolio-cron.php' )
