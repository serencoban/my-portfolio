...
function wp_logout_url( $redirect = '' ) {
	...
	$logout_url = add_query_arg( $args, site_url( 'my-portfolio-login.php?action=logout', 'login' ) );
...
function wp_login_url( $redirect = '', $force_reauth = false ) {
	$login_url = site_url( 'my-portfolio-login.php', 'login' );
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'my-portfolio-login.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = array() ) {
	...
	$form =
		sprintf(
			...
			esc_url( site_url( 'my-portfolio-login.php', 'login_post' ) )
		) .
		$login_form_top .
		sprintf(
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	if ( is_multisite() ) {
		...
		$wp_login_path = $blog_details->path . 'my-portfolio-login.php';
	} else {
		$wp_login_path = 'my-portfolio-login.php';
	}
