 ...
 *
 * A constant `WP_DISABLE_FATAL_ERROR_HANDLER` can be set in `my-portfolio-config.php` to disable it, or alternatively the
...
function wp_is_fatal_error_handler_enabled() {
	 ...
	 * a `$wp_filter` global before WordPress loads, usually in `my-portfolio-config.php`.
	 *
	 * Example:
	 *
