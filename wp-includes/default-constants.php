<?php
/**
 * Defines constants and global variables that can be overridden, generally in my-portfolio-config.php.
 *
 * @package WordPress
 */
...
function wp_initial_constants() {
	 ...
	 * define( 'WP_DEVELOPMENT_MODE', 'theme' ), or define( 'WP_DEVELOPMENT_MODE', 'all' ) to my-portfolio-config.php
	...
	// Add define( 'WP_DEBUG', true ); to my-portfolio-config.php to enable display of notices during development.
	if ( ! defined( 'WP_DEBUG' ) ) {
	...
	/*
	 * Add define( 'WP_DEBUG_DISPLAY', null ); to my-portfolio-config.php to use the globally configured setting
	...
	/*
	 * Add define( 'SCRIPT_DEBUG', true ); to my-portfolio-config.php to enable loading of non-minified,
