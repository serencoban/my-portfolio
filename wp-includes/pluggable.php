...
if ( ! function_exists( 'wp_new_user_notification' ) ) :
	...
	function wp_new_user_notification( $user_id, $deprecated = null, $notify = '' ) {
		 ...
		 */
		$message .= network_site_url( 'my-portfolio-login.php?login=' . rawurlencode( $user->user_login ) . "&key=$key&action=rp", 'login' ) . "\r\n\r\n";
...
if ( ! function_exists( 'wp_salt' ) ) :
	 ...
	 * in the database and in the my-portfolio-config.php file. The secret key in the database
	 * is randomly generated and will be appended to the secret keys in my-portfolio-config.php.
	 *
	 * The secret keys in my-portfolio-config.php should be updated to strong, random keys to maximize
	 * security. Below is an example of how the secret key constants are defined.
	 * Do not paste this example directly into my-portfolio-config.php. Instead, have a
	 ...
	 * @since 2.5.0
	 *
	 * @link https://api.wordpress.org/secret-key/1.1/salt/ Create secrets for my-portfolio-config.php
	 *
